        ...
        <div className="flex-1 px-5 lg:px-8 lg:pt-8 w-full flex flex-col max-w-7xl mx-auto">
          ...
          <div className="hidden lg:flex justify-between items-center mb-8">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-3xl font-extrabold text-[#1B2B48] tracking-tight">Home Stay</h2>
            </div>
          ...
          <div className="relative w-full h-[180px] lg:h-[220px] rounded-[32px] overflow-hidden shadow-[0_10px_40px_rgba(92,58,33,0.08)] mb-8 bg-[#FFFFFF] flex flex-row">
            ...
            <div className="absolute inset-y-0 right-0 w-[55%] lg:w-[65%] z-0">
                ...
                <div className="absolute inset-y-0 left-0 w-12 lg:w-32 bg-gradient-to-r from-[#FFFFFF] via-[#FFFFFF]/80 to-transparent"></div>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-3 lg:space-y-3.5 mb-10">
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-[#1B2B48]/40 group-hover:text-[#1B2B48] group-hover:translate-x-1 transition-all">
          ...
          <div className="mt-auto mb-10 relative h-[120px] lg:h-[140px] rounded-[32px] bg-transparent flex items-end justify-center">
             <div className="absolute inset-0 flex flex-col items-center justify-center opacity-60">
                ...
                <span className="font-caveat text-xl lg:text-2xl font-bold text-[#FBBF24] rotate-[-5deg] ml-8">
                  Happier Business ♥
                </span>
             </div>
          </div>
