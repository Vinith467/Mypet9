...
export const CaretakerDashboardScreen = () => {
  ...
  return (
    <CaretakerLayout>
      <div className="w-full flex flex-col bg-[#FAFAFA] min-h-screen font-quicksand pb-24 lg:pb-12 text-[#1B2B48]">
        ...
        <div className="flex-1 px-5 lg:px-12 lg:pt-10 w-full flex flex-col">
          ...
          <div className="hidden lg:flex justify-between items-center mb-8">
             <h2 className="text-3xl font-extrabold text-[#1B2B48] tracking-tight">Overview</h2>
          ...
          <div className="relative w-full mb-6 lg:mb-10 bg-[#FFFFFF] rounded-[24px] lg:rounded-[32px] p-4 lg:p-12 flex flex-col lg:flex-row items-center justify-between shadow-[0_8px_30px_rgba(92,58,33,0.04)] border border-white relative overflow-hidden">
            ...
            <div className="flex-1 z-10 max-w-2xl">
              ...
              <p className="text-[#1B2B48] text-sm lg:text-xl font-semibold mb-1">
                Happy pets. Happier tomorrows.
              </p>
              <p className="text-[#1B2B48]/80 text-[11px] lg:text-base font-medium leading-relaxed">
            ...
            <div className="w-full lg:w-[480px] h-[180px] lg:h-[280px] relative rounded-[16px] lg:rounded-[32px] overflow-hidden shadow-[0_10px_40px_rgba(92,58,33,0.12)] group mt-4 lg:mt-0 z-10 shrink-0">
               <img 
                ...
                <div className="absolute top-2 right-2 lg:top-6 lg:right-6 bg-white px-2 py-1.5 lg:px-4 lg:py-3 rounded-xl lg:rounded-2xl shadow-lg flex flex-col items-center animate-bounce-slow">
                  <Heart size={14} className="text-[#FBBF24] mb-0.5 lg:mb-1" fill="currentColor"/>
                  <span className="font-bold text-[#1B2B48] text-[9px] lg:text-[12px] text-center leading-tight">
            ...
            {(!services || services.homeStay || services.boarding) && (
              ...
              >
                  ...
                  <div className="hidden lg:flex items-center space-x-4">
                    <div className="flex items-center space-x-2 shrink-0">
                      <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-sm">
                        <Home size={10} className="text-[#FBBF24] lg:w-3 lg:h-3" />
                      </div>
                      <span className="text-[10px] font-extrabold text-[#1B2B48] uppercase tracking-widest leading-none">Safe</span>
                    </div>
                    <div className="w-[1px] h-6 bg-[#FBBF24]/10 shrink-0"></div>
                    <div className="flex items-center space-x-2 shrink-0">
                      <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-sm">
                        <Heart size={10} className="text-[#FBBF24] lg:w-3 lg:h-3" />
                      </div>
                      <span className="text-[10px] font-extrabold text-[#1B2B48] uppercase tracking-widest leading-none">Happy</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-2/5 lg:w-[45%] shrink-0 relative z-0 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-y-0 left-0 w-[1px] bg-[#1B2B48]/5"></div>
                  
                  <div className="absolute bottom-3 right-3 lg:bottom-8 lg:right-8 w-8 h-8 lg:w-12 lg:h-12 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.12)] group-hover:bg-[#1B2B48] transition-colors duration-300">
                    <ArrowRight size={14} className="text-[#1B2B48] group-hover:text-white transition-colors lg:w-5 lg:h-5" />
                  </div>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="flex-1 min-w-0 relative z-10 p-4 lg:p-8 flex flex-col h-full justify-between">
                  ...
                  <div className="hidden lg:flex items-center space-x-4">
                    <div className="flex items-center space-x-2 shrink-0">
                      <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-sm">
                        <Sparkles size={10} className="text-[#FBBF24] lg:w-3 lg:h-3" />
                      </div>
                      <span className="text-[10px] font-extrabold text-[#1B2B48] uppercase tracking-widest leading-none">Pro</span>
                    </div>
                    <div className="w-[1px] h-6 bg-[#FBBF24]/10 shrink-0"></div>
                    <div className="flex items-center space-x-2 shrink-0">
                      <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-sm">
                        <PawPrint size={10} className="text-[#FBBF24] lg:w-3 lg:h-3" />
                      </div>
                      <span className="text-[10px] font-extrabold text-[#1B2B48] uppercase tracking-widest leading-none">Fresh</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="hidden lg:flex w-full bg-white rounded-2xl p-5 shadow-[0_4px_16px_rgba(92,58,33,0.03)] border border-[#1B2B48]/5 flex-row justify-between items-center relative overflow-hidden">
            
            <div className="flex items-center gap-1.5 lg:space-x-3">
              <div className="w-7 h-7 lg:w-10 lg:h-10 rounded-lg lg:rounded-xl bg-[#FFFFFF] flex items-center justify-center border border-[#FBBF24]/10 shrink-0">
                <ShieldCheck size={14} className="text-[#FBBF24] lg:w-[18px] lg:h-[18px]" />
              </div>
              <span className="text-[9px] lg:text-[13px] font-bold text-[#1B2B48] leading-tight">Verified<br/>Partners</span>
            </div>
            
            <div className="w-[1px] h-6 lg:h-8 bg-[#1B2B48]/10 shrink-0 mx-1"></div>
            
            <div className="flex items-center gap-1.5 lg:space-x-3">
              <div className="w-7 h-7 lg:w-10 lg:h-10 rounded-lg lg:rounded-xl bg-[#FFFFFF] flex items-center justify-center border border-[#FBBF24]/10 shrink-0">
                <PawPrint size={14} className="text-[#FBBF24] lg:w-[18px] lg:h-[18px]" fill="currentColor" />
              </div>
              <span className="text-[9px] lg:text-[13px] font-bold text-[#1B2B48] leading-tight">₹50k<br/>Cover</span>
            </div>
            ...
            <div className="flex items-center gap-1.5 lg:space-x-3">
              <div className="w-7 h-7 lg:w-10 lg:h-10 rounded-lg lg:rounded-xl bg-[#FFFFFF] flex items-center justify-center border border-[#FBBF24]/10 shrink-0">
                <Users size={14} className="text-[#FBBF24] lg:w-[18px] lg:h-[18px]" />
              </div>
              <span className="text-[9px] lg:text-[13px] font-bold text-[#1B2B48] leading-tight">Growing<br/>Community</span>
            </div>
          </div>
