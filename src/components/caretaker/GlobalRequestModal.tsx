            ...
            {modalStep === 'details' ? (
              ...
              <>
                ...
                <div className="flex flex-col w-full">
                  ...
                  <button 
                    ...
                    className="w-full py-2.5 rounded-xl bg-[#612117] text-white font-extrabold text-[15px] hover:bg-[#4A1617] transition-colors shadow-sm"
                  >
                    Send Quotation
                  </button>
                </div>
              ...
              <div className="flex flex-col items-center pt-1 pb-1 w-full max-w-[400px] mx-auto">
                ...
                <div className="relative mb-4 mt-2">
                  <div className="w-[84px] h-[84px] bg-[#FDE8E8] rounded-full flex items-center justify-center">
                    <Send className="text-[#7B1C1D] w-10 h-10 -ml-1 mt-1 transform -rotate-45" fill="currentColor" />
                  </div>
                </div>

                <h2 className="text-[24px] font-extrabold text-[#7B1C1D] mb-1 text-center">Quotation Sent!</h2>
                <p className="text-[#4A1D1A]/70 text-[14px] font-medium text-center mb-5 max-w-[280px]">
                  Your quote has been sent to the pet parent.
                </p>

                {/* Quote Summary */}
                <div className="w-full bg-[#FCF8F5] rounded-[20px] p-5 mb-5">
                  <h3 className="text-[#7B1C1D] font-extrabold text-[15px] mb-3">Quote Summary</h3>
                  <div className="flex items-end mb-3">
                    <span className="text-[#7B1C1D] font-extrabold text-[22px] leading-none mr-2">₹ {quotePrice}</span>
                    <span className="text-[#4A1D1A]/60 font-medium text-[14px] mb-0.5">per night</span>
                  </div>
                  <div className="w-full h-px bg-[#F3EBE1] mb-3"></div>
                  <div className="flex items-center justify-between">
                    <span className="text-[#7B1C1D] font-extrabold text-[15px]">Total ({req.nights} nights)</span>
                    <span className="text-[#7B1C1D] font-extrabold text-[22px]">₹ {formatCurrency(quoteTotal)}</span>
                  </div>
                </div>

                {/* Info Box */}
                <div className="w-full bg-[#F5F8FF] rounded-2xl p-4 flex items-start space-x-3 mb-5">
                  <Info className="text-[#4A1D1A]/60 w-5 h-5 shrink-0 mt-0.5" />
                  <p className="text-[#4A1D1A]/70 text-[13px] font-medium leading-snug">
                    You will be notified once the customer responds.
                  </p>
                </div>
                ...
                <button 
                  ...
                  className="w-full py-3.5 rounded-xl border-2 border-[#7B1C1D] text-[#7B1C1D] font-extrabold text-[15px] hover:bg-[#F6EBE5] transition-colors"
                >
                  View in Requests
                </button>
              </div>
