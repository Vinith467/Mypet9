...
export const Navigation = () => {
  ...
  return (
    <nav className="fixed lg:sticky lg:top-0 bottom-0 left-0 right-0 lg:right-auto w-full lg:w-[280px] lg:h-screen bg-white lg:bg-transparent z-50 flex lg:flex-col lg:px-6 lg:py-10 shadow-[0_-8px_30px_-15px_rgba(0,0,0,0.08)] lg:shadow-none border-t lg:border-t-0 border-[#1B2B48]/5">
